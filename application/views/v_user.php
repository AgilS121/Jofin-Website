...
$query = $conn->query("SELECT * FROM tb_users");

$jml_users = mysqli_num_rows($query);
?>
<!-- Begin Page Content -->
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">DataTables Pendaftaran(<?= $jml_users ?>)</h6>
        </div>
        <div class="card-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url() . 'user/hapus_file' ?>" method="post" enctype="multipart/form-data">
